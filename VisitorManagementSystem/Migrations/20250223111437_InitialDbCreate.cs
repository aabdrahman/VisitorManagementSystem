        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorEmailAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PurposeOfVisit = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisitorIdentificationNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisitorGender = table.Column<int>(type: "int", nullable: false),
                    VisitationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VisitType = table.Column<int>(type: "int", nullable: false),
                    VisitorRegistrationType = table.Column<int>(type: "int", nullable: false),
                    CheckTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CheckOutTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReceptionistName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HostName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AssignedCardNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitorName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisitorPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VisitorEmailAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
